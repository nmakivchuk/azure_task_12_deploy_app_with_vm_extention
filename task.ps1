...
$vmImage = "Ubuntu2204"
$vmSize = "Standard_B1s"
$dnsLabel = "matetask4me" + (Get-Random -Count 1)
...
$Params = @{
    ...
    ProtectedSettings  = @{
        fileUris = @('https://raw.githubusercontent.com/nmakivchuk/azure_task_12_deploy_app_with_vm_extention/develop/install-app.sh')
